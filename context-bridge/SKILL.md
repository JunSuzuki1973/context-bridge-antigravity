...
- **メリット**: API消費ゼロ、Gemini 1.5 Proなら100万トークン対応で大規模プロジェクトも一括送信可能
...
3. Gemini 1.5 Proの100万トークンコンテキストを活用したい場合
...
| AI | コンテキスト長 | 推奨度 |
|----|--------------|--------|
| Google AI Studio (Gemini 1.5 Pro) | 100万トークン | ⭐⭐⭐ 強く推奨 |
| ChatGPT (GPT-4) | 128Kトークン | ⭐⭐ 中規模プロジェクト向け |
